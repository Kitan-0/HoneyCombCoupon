package com.geigeoffer.honeycombcoupon.merchant.admin.mq.producer;

import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson2.JSON;
import com.geigeoffer.honeycombcoupon.merchant.admin.mq.base.BaseSendExtendDTO;
...
public abstract class AbstractCommonSendProduceTemplate<T> {
     ...
     * @return 消息基本参数
     */
    protected abstract Message<T> buildMessage(T messageSendEvent, BaseSendExtendDTO requestParam);
    /**
     * 消息事件通用发送
     *
     * @param messageSendEvent 消息发送事件
